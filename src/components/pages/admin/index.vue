...
import { auth } from '../../../services/engine.mjs'; // Import your Firebase authentication module
import { useRouter } from 'vue-router';

import adminHeader from './component/header.vue';
import adminTable from './component/table.vue';
...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      if (currentUser.value.uid !== 'SeFPNc7VwPaNYhgW4vgK4TyaPGL2') {
